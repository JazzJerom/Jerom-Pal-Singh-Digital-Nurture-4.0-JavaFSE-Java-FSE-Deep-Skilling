...
public class InventoryManagementSystem {
    ...
    public static void main(String[] args) {
        ...
        system.addProduct(new Product(101, "Smartphone", 10, 55000));
        system.addProduct(new Product(102, "Running shoes", 50, 500));
        system.addProduct(new Product(103, "coffee mug", 30, 1200));
